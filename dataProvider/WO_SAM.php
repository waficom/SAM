...
class WO_SAM
{
    ...
    public function getWO_SAM(stdClass $params)
    {
    ...
    public function addWO_SAM(stdClass $params)
    {
        ...
        $sql=("execute procedure get_wo_sam_i '$params->status','$params->no_ppd','$userinput','$useredit','$params->keterangan',
    ...
    public function updateWO_SAM(stdClass $params)
    {
        if($params->status=='true'){
            $params->status = '1';
        }else{
        ...
        $sql=("execute procedure get_wo_sam_u ' $params->posted_date','$params->status','$params->wo_num','$params->no_ppd','$useredit','$params->keterangan',
        '$params->ka_shift','$params->shift','$co_id'
        ");
        $this->db->setSQL($sql);
        $this->db->execOnly();
    }
    public function deleteWO_SAM(stdClass $params)
    {
        $company =  $_SESSION['user']['site'];
    ...
    public function getWOBB_SAM(stdClass $params)
    {
        $company =  $_SESSION['user']['site'];
    ...
    public function addWOBB_SAM(stdClass $params)
    {
    ...
    public function updateWOBB_SAM(stdClass $params)
    {
        $data = get_object_vars($params);
        unset($data['id'], $data['bb_nama'], $data['status'] );
    ...
    public function getWOBJM_SAM(stdClass $params)
    {
        $company =  $_SESSION['user']['site'];
        $sql = "select A.*
        from wo2 A
    ...
    public function updateWOBJM_SAM(stdClass $params)
    {
        $data = get_object_vars($params);
    ...
    public function addWOBBPaket_SAM(stdClass $params)
    {
        $co_id= $_SESSION['user']['site'];
        $sql=("execute procedure get_wo_paket '$params->jml_paket','$params->wo_num','$params->no_ppd','$co_id'
        ");
        $this->db->setSQL($sql);
        $this->db->execOnly();
        return $params;
