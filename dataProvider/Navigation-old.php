...
class Navigation
{
	...
	public function getNavigation()
	{
		...
		$nav = array(
			array(
				'text' => $this->i18n['dashboard'], 'disabled' => true, 'leaf' => true, 'cls' => 'file', 'iconCls' => 'icoDash', 'id' => 'panelDashboard'
...
//		}
		...
		|| $this->ACL->hasPermission('access_roles')) array_push($nav, $admin);
*/
        array_pusth($nav, $admin);
		// *************************************************************************************
