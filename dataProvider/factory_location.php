...
class Factlocation
{
     ...
     */
     ...
     public function getFactlocation(stdClass $params)
    {
     ...
     * @return stdClass
     */
    public function addFactlocation(stdClass $params)
    {
     ...
     * @return stdClass
     */
    public function updateFactlocation(stdClass $params)
    {
        $data = get_object_vars($params);
        $data['co_id'] = $_SESSION['user']['site'];
        $data['useredit'] = $_SESSION['user']['name'];
     ...
     * @return stdClass
     */
    public function deleteFactlocation(stdClass $params)
    {
