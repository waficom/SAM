Ext.define('App.ux.VendorTransporterPopup',
    {
        extend : 'Ext.form.field.Trigger',
        alias : 'widget.xtVendorTransporterPopup',
        ...
        initComponent : function()
        {
            ...
            Ext.define('VendorTransporterSearchModel',
                {
                    ...
                    {
                        type : 'direct',
                        api : {read : Popup.VendorTransporterPopup},
                        reader : {
            ...
            me.store = Ext.create('Ext.data.Store',
                {
                    model : 'VendorTransporterSearchModel',
                    pageSize : 50,
                    autoLoad : false
                });
