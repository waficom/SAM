        ...
        me.SalesmanGrid = Ext.create('App.ux.GridPanel', {
            ...
            listeners: {
                ...
                itemdblclick: function(view, record){
                    ...
                    me.onItemdblclick(me.SalesmanStore, record, 'Edit Salesman');
                }
            },
            dockedItems: [
                {
                    ...
                    items: [
                        {
                            ...
                            handler: function(){
                                ...
                                me.onNew(form, 'SalesmanModel', 'Tambah Data');
                            }
                        },'->',
                        {
                            xtype: 'button',
