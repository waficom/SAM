Ext.define('App.view.transaksi.CashBook.Cashbook_Out', {
    ...
    initComponent : function()
    {
                                    ...
                                    items:[
                                        ...
                                        },
                                        {
                                            ...
                                            handler: function(field, value) {
                                                if (value== true) {
                                                    Ext.ComponentQuery.query('#tgl_post_cbout')[0].setDisabled(false);
                                                    Ext.ComponentQuery.query('#tgl_post_cbout')[0].setValue(new Date());
                                                }else{
                                                    Ext.ComponentQuery.query('#tgl_post_cbout')[0].setDisabled(true);
                                                }
        ...
        me.CB_OUTDetailGrid = Ext.create('Ext.grid.Panel', {
        ...
        me.FormulirPanel = Ext.create('Ext.tab.Panel', {
            activeTab:0,
            items:[ me.CB_OUTGrid, me.CB_OUTDetailGrid ]
        });
    ...
    onNewRec:function(btn){
        ...
        if(model == 'CB_OUTDetailModel'){
            Ext.ComponentQuery.query('#inv_code_cbout')[0].setValue(me.kode);
        }else{
            Ext.ComponentQuery.query('#tgl_input_cbout')[0].setValue(new Date());
            Ext.ComponentQuery.query('#tax_code_cbout')[0].setValue('NT01');
        }
    },
