Ext.define('App.view.transaksi.CashBook.Cashbook_Out', {
    ...
    initComponent: function(){
            ...
            listeners: {
                ...
                itemdblclick: function(view, record){
                    if(record.get('status')!=1){
                        me.onItemdblclick(me.Cashbook_OutStore, record, 'Edit CashBook Out');
                        Ext.getCmp('post_cb_out').enable();
                    }
                    ...
                    items: [
                        {
                            ...
                            handler: function(){
                                ...
                                Ext.getCmp('post_cb_out').disable();
                            }
                        },
                        {
                            xtype: 'button',
            ...
            listeners: {
                ...
                itemdblclick: function(view, record){
                    if(me.currPosted !='1'){
                        ...
                        me.onItemdblclick1(me.Cashbook_Out_JurnalStore, record, 'Edit CashBook Out Jurnal', me.winformCb_Out_Jurnal, form);
                    }
            ...
            dockedItems: [
                {
                    ...
                    items: [{
                    ...
                    },
                        {
                            ...
                            iconCls: 'delete',
                            handler: function() {
                                me.deleteProduksi1(me.Cashbook_Out_JurnalStore, me.Cb_Out_JurnalGrid);
                            }
                        }
                    ]
                },{
            ...
            buttons: [
                {
                    ...
                    handler: function(){
                        ...
                        if(form.isValid()){
                            me.onProduksi3Save(form, me.Cashbook_Out_JurnalStore, me.winformCb_Out_Jurnal);
                        }
                    }
                },{
                    text: i18n('cancel'),
        ...
        me.pageBody = [me.Cashbook_OutGrid, me.Cb_Out_JurnalGrid];
...
//                    PB.deletePB(bid);
    ...
    onActive: function(callback){
        var me = this;
        this.Cashbook_OutStore.load({params:{start:0, limit:5}});
