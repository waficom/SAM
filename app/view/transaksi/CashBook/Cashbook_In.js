Ext.define('App.view.transaksi.CashBook.Cashbook_In', {
                                    ...
                                    items:[
                                        ...
                                        },
                                        {
                                            ...
                                            handler: function(field, value) {
                                                if (value== true) {
                                                    Ext.ComponentQuery.query('#tgl_post_pcbin')[0].setDisabled(false);
                                                    Ext.ComponentQuery.query('#tgl_post_pcbin')[0].setValue(new Date());
                                                }else{
                                                    Ext.ComponentQuery.query('#tgl_post_pcbin')[0].setDisabled(true);
                                                }
    ...
    onNewRec:function(btn){
        ...
        if(model=='CB_INDetailModel'){
            Ext.ComponentQuery.query('#inv_code_cbin')[0].setValue(me.kode);
        }else{
            Ext.ComponentQuery.query('#tgl_input_cbin')[0].setValue(new Date());
            Ext.ComponentQuery.query('#tax_code_cbin')[0].setValue('NT02');
