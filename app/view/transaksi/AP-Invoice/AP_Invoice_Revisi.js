Ext.define('App.view.transaksi.AP-Invoice.AP_Invoice_Revisi', {
    extend: 'App.ux.RenderPanel',
    id: 'panelAP_Invoice_Revisi',
    pageTitle: 'AP Invoice Revisi',
    pageLayout: 'border',
    ...
    initComponent: function(){
        ...
        me.AP_InvStore = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'direct',
                api: {
                    read: AP_Invoice.getAP_Inv_Revisi,
                    create: AP_Invoice.addAP_Inv_Revisi,
        ...
        me.AP_InvGrid = Ext.create('App.ux.GridPanel', {
            ...
            columns: [
                ...
                {width: 200,text: 'Nilai',sortable: true,dataIndex: 'nilaidasarx', renderer: Ext.util.Format.numberRenderer('0,000.00')},
                ...
                {width: 200,text: 'Total',sortable: true,dataIndex: 'totalx',renderer: Ext.util.Format.numberRenderer('0,000.00')},
