Ext.define('App.view.transaksi.AP-Invoice.Jurnal_Penyusutan_Aset', {
    extend: 'App.ux.RenderPanel',
    id: 'panelJurnal_Penyusutan_Aset',
    pageTitle: 'Jurnal Penyusutan Aset',
    pageLayout: 'border',
    ...
    initComponent: function(){
        ...
        me.ReclassStore = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'direct',
                api: {
                    read: Jurnal_Penyusutan_Aset.getJurnal_Penyusutan_Aset
                },
                reader : {
